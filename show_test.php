...
require_once 'app/entity/Group.php';
require_once 'app/entity/Post.php';
require_once 'app/repository/UserRepo.php';
require_once 'app/repository/GroupRepo.php';
require_once 'app/repository/PostRepo.php';
