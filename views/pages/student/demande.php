<?php
// demande.php — Formulaire de demande administrative (vue étudiant)
session_start();
$config = require __DIR__ . '/config/demande.php';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<div class="wrap">
    ...
    <main>
        ...
        <form class="card form-card" method="POST" action="traitement_demande.php">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-textarea" id="dem-commentaire" name="commentaire"
