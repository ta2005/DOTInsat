...
$reqS1 = $bdd->prepare("SELECT nom_matiere, coefficient FROM matieres WHERE filiere = 'RT' AND niveau = 3 AND semestre = 1");
$reqS1->execute();
$matieresS1 = $reqS1->fetchAll(PDO::FETCH_ASSOC);

// Nrécupéri matiérét S2
$reqS2 = $bdd->prepare("SELECT nom_matiere, coefficient FROM matieres WHERE filiere = 'RT' AND niveau = 3 AND semestre = 2");
$reqS2->execute();
...
<head>
    <meta charset="utf-8">
    <title>INSAT Grade Calculator - RT3</title>
...
<body>
    ...
    <div id="showing">Currently showing: RT3</div>
    <?php
        $sansTP = ['Optimisation non linéaire','Statistiques pour l\'ingénieur','Anglais','Arabe','Français','Théorie des organisations','Communication dans l\'entreprise','Processus stochastiques et files d\'attente','Logique formelle','Réseaux radio-mobiles cellulaires','Ingénierie des protocoles','Anglais','Marketing'];
